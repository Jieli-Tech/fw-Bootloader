...
typedef struct {
    __RW __u32 CON[15]; // only 0-3 used
    __RO __u32 REV0;
    __RW __u32 CID[15]; // only 0-3 used
    __RO __u32 REV1;
    __RW __u32 BEG[15]; // only 0-3 used
    __RO __u32 REV2;
    __RW __u32 END[15]; // only 0-3 used
    __RW __u32 WREN;
} JL_MPU_TypeDef;
