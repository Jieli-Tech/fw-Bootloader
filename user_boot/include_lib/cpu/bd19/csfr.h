...
#define JL_MBIST_BASE                    (csfr_base + map_adr(0x06, 0x00))
...
#define q32small_sfr_offset  0x000800
#define q32small_sfr_base    (csfr_base + 0xe000)

#define q32small_cpu_base    (q32small_sfr_base + 0x0000)
#define q32small_icu_base    (q32small_sfr_base + 0x0400)

#define q32small(n)          ((JL_TypeDef_q32small     *)(q32small_sfr_base + q32small_sfr_offset*n))
#define q32small_icu(n)      ((JL_TypeDef_q32small_ICU *)(q32small_icu_base + q32small_sfr_offset*n))
